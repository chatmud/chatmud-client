<script lang="ts">
  ...
  let groups = $derived<ShortcutGroup[]>([
    ...
    },
    {
      title: 'Output Review',
      shortcuts: [
        { keys: 'Ctrl/Cmd+Shift+U', description: 'Previous line (skip blanks)' },
        { keys: 'Ctrl/Cmd+Shift+O', description: 'Next line (skip blanks)' },
        { keys: 'Ctrl/Cmd+Shift+I', description: 'Read current line' },
        { keys: 'Ctrl/Cmd+Shift+Y', description: 'Jump to top' },
        { keys: 'Ctrl/Cmd+Shift+N', description: 'Jump to bottom' },
        { keys: 'Ctrl/Cmd+Shift+H', description: 'Report line position' },
        { keys: 'Ctrl/Cmd+1-9 / 0', description: 'Read line N from end (1 = last)' },
        { keys: 'Ctrl/Cmd+1-9 (double)', description: 'Copy line N to clipboard' },
        { keys: 'Ctrl/Cmd+1-9 (triple)', description: 'Paste line N into input' },
        { keys: 'Ctrl/Cmd+Shift+Space', description: 'Start / end selection (line breaks)' },
        { keys: 'Ctrl/Cmd+Shift+Alt+Space', description: 'Start / end selection (spaces)' },
        { keys: 'Ctrl/Cmd+Shift+C', description: 'Clear output buffer' },
        { keys: 'Ctrl/Cmd+Alt+O', description: 'Toggle ARIA live regions' },
      ],
    },
    {
      title: 'Editor',
